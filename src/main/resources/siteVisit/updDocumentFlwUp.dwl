...
DOCUMENT_TYPE: (vars.inputPayload.documentType splitBy(","))[1],
DOCUMENT_SENT_DATE: vars.inputPayload.followUpLetterDate,
...
DOC_TYPE: substringAfter((vars.inputPayload.documentType splitBy(","))[1],' ')
